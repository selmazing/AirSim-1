...
class SandBox:
    def __init__(self, *args):
        ...
        path_to_jsbsim = os.path.join(os.path.dirname(sys.argv[0]), 'C:/Users/quessy/Dev/jsbsim/', *args)
...
def CreateFDM(sandbox, pm=None):
    _fdm = jsbsim.FGFDMExec(os.path.join(sandbox(), 'C:/Users/quessy/Dev/jsbsim/'), pm)
    path = sandbox.path_to_jsbsim_file()
    _fdm.set_aircraft_path(os.path.join(path, 'C:/Users/quessy/Dev/jsbsim/aircraft/'))
    _fdm.set_engine_path(os.path.join(path, 'C:/Users/quessy/Dev/jsbsim/engine/'))
    _fdm.set_systems_path(os.path.join(path, 'C:/Users/quessy/Dev/jsbsim/systems/'))
    return _fdm
...
def CopyAircraftDef(script_path, sandbox):
    ...
    aircraft_path = os.path.join('C:/Users/quessy/Dev/jsbsim/aircraft/', aircraft_name)
...
class FlightModel:
    def __init__(self, test_case, name):
        self.path = test_case.sandbox.path_to_jsbsim_file('C:/Users/quessy/Dev/jsbsim/tests')
