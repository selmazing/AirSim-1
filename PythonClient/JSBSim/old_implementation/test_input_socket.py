...
import telnetlib, time, threading, socket
import xml.etree.ElementTree as et
from JSBSim.old_implementation.JSBSim_utils import JSBSimTestCase, CreateFDM, CopyAircraftDef, RunTest
...
class TelnetInterface:
    ...
    def __del__(self):
        if 'tn' in self.__dict__.keys():  # Check if the Telnet session has been successfully open
            self.tn.close()
        self.thread.quit = True
        self.thread.join()
        del self.thread

    def sendCocmmand(self, command):
        self.cond.acquire()
...
class TestInputSocket(JSBSimTestCase):
    def setUp(self):
        ...
        self.script_path = self.sandbox.path_to_jsbsim_file('C:/Users/quessy/Dev/jsbsim/scripts/',
                                                            'c1722.xml')
    ...
    def test_input_socket(self):
        ...
        tree.write(self.sandbox('C:/Users/quessy/Dev/jsbsim/aircraft/', aircraft_name,
                                aircraft_name+'.xml'))
    ...
    def test_script_input(self):
        ...
        tree.write('C:/Users/quessy/Dev/jsbsim/aircraft/c172x/c1722_1.xml')

        fdm = CreateFDM(self.sandbox)
        fdm.load_script('C:/Users/quessy/Dev/jsbsim/aircraft/c172x/c1722_1.xml')
        fdm.run_ic()
        fdm.hold()
