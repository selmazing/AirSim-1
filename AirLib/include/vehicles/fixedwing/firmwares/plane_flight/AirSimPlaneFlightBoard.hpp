...
#ifndef msr_airlib_AirSimPlaneFlightBoard_hpp
#define msr_airlib_AirSimPlaneFlightBoard_hpp
...
class AirSimPlaneFlightBoard : public plane_flight::IBoard {
public:
    AirSimPlaneFlightBoard(const plane_flight::Params* params)
        : params_(params)
    {
    }
...
private:
    ...
    const plane_flight::Params* params_;
