...
public:
        ...
        offboard_api_(params, board, board, state_estimator, comm_link), mixer_(params)
    {
        ...
        case Params::ControllerType::Cascade:
            controller_ = std::unique_ptr<CascadePlaneController>(new CascadePlaneController(params, board, comm_link));
            break;
        case Params::ControllerType::Adaptive:
            controller_ = std::unique_ptr<AdaptivePlaneController>(new AdaptivePlaneController());
            break;
        default:
